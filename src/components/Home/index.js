...
import StateWiseRec from '../StateWiseRec'
import HomeCardItem from '../HomeCardItem'
import SearchRecommendItems from '../SearchRecommendItems'
  ...
  renderCovidCasesData = () => {
    ...
    return (
      <div className="home-route-bg-container ">
        ...
        <div className="states-records-bg-container">
          {showStateStats && (
            <div className="stats-bg-section">
              <div className="difftype-total-case-cards-container">
                <HomeCardItem stateTotal={sum} />
              </div>

              <div
                className="state-wise-records-container"
                //  testid="stateWiseCovidDataTable"
              >
                <div className="statewise-total-table-record-container">
