...
import IndividualCaseCard from '../IndividualCaseCard'
import DistrictItemCard from '../DistrictItemCard'
import TimelineDataCard from '../TimelineDataCard'
...
class StateSpecificDetails extends Component {
  ...
  renderStateSpecificData = () => {
    ...
    return (
      <div className="state-specific-bg-route">
        <div className="banner-bg-container">
          <div className="state-details-bg-container">
            <h1 className="state-nameCard">{StateName}</h1>
            <p className="Details-last-update">{`Last Updated on ${lastUpdatedDate}`}</p>
          </div>
          <div className="tested-count-bg-container">
            <p className="tested-heading">Tested</p>
            <p className="test-count">{testedCount}</p>
          </div>
        </div>

        <ul className="unordered-cases-types">
        ...
        <TimelineDataCard activeCaseClass={activeCaseClass} />
        <Footer />
      </div>
    )
  }
